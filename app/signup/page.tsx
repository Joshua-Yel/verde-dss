    ...
    <div className="min-h-screen w-full bg-background flex flex-col">
      <div className="flex-1 flex">
        ...
        <aside className="w-10 sm:w-14 shrink-0 bg-primary flex flex-col items-center justify-between py-6">
          ...
          <span className="text-primary-foreground/50 text-[10px] font-mono">No. 02</span>
        </aside>
        ...
        <main className="flex-1 flex items-start justify-center px-6 py-8 sm:py-14">
          <div className="w-full max-w-xl">
            ...
            {success ? (
              <div className="rounded-lg border px-4 py-3 text-sm border-[var(--success)] bg-[var(--success-light)] text-[var(--success)]">
                Check your email for a confirmation link. Redirecting to sign in…
              </div>
            ) : (
                ...
                <div className="divide-y divide-border border-b border-border">
                  ...
                  <div className="grid grid-cols-[9rem_1fr] sm:grid-cols-[11rem_1fr] items-center gap-4 py-4">
                    ...
                    <input
                      ...
                      placeholder="e.g. Salon Branch 1"
